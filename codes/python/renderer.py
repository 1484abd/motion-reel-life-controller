...
GRID_COLOR = (40, 40, 50)
AXIS_X_COLOR = (255, 70, 70)
AXIS_Y_COLOR = (70, 140, 255)
...
class RoomView:
    ...
    def _draw(self, font):
        ...
        (fx, fy), (rx, ry) = player_axis(angle)
        axis_len = 30

        x_tip = psx + fx * axis_len
        y_tip = psy - fy * axis_len
        pygame.draw.line(self.screen, AXIS_X_COLOR, (psx, psy), (x_tip, y_tip), 3)

        y_axis_tip_x = psx + rx * axis_len
        y_axis_tip_y = psy - ry * axis_len
        pygame.draw.line(self.screen, AXIS_Y_COLOR, (psx, psy), (y_axis_tip_x, y_axis_tip_y), 3)
        ...
        info_lines = [
            ...
            f"Player axis -> X (red, front): {angle:.1f} deg   Y (blue, right): {(angle + 90) % 360:.1f} deg",
